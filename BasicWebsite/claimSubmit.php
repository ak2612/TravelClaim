<?php 
 ...
 if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `travelclaim` (`claimId`, `empId`, `travelType`, `startDate`, `endDate`, `source`, `destination`, `status`, `officeOrder`, `travelDetails`, `documents`,`approver`) VALUES ('$claimId','$empId','$travelType','$startDate','$endDate','$source','$destination','$status','$officeOrder','$jsonEncodedData','$allDoc','$roid');";
