...
<body id="body-pd">
    ...
    <div class="container">
        <div class="row  row-cols-1 row-cols-md-3 mb-3 justify-content-center" style="padding-top:3%">
            <div class="col">
    ...
    <?php
    $e = $_SESSION["empid"];
    $query = "SELECT * FROM `user` WHERE `empid`='$e'";
        ...
        <div class="row  row-cols-1 row-cols-md-3 mb-3 text-center" style="padding-top:3%">
            ...
            <div class="col">
                <div class="card card4">
                    ...
                    <div class="card-footer text-muted" style="border: none;">
                        <a class="nav-link text-white" href="approvedClaims.php">Approved Claims</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card card5">
                    ...
                    <div class="card-footer text-muted" style="border: none;">
                        <a class="nav-link text-white" href="rejectedClaims.php">Rejected Claims</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".card4").bind("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", function() {
                $(this).removeClass('animate__animated animate__pulse');
            });
            $(".card5").hover(function() {
                $(this).addClass('animate__animated animate__pulse');
            });
            $(".card5").bind("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", function() {
                $(this).removeClass('animate__animated animate__pulse');
            });
        });
        function checkPass(){
