            ...
            <div class="card">
                ...
                <div class="form-group p-2 col-md-6">
                    <div class="input-group mb-3 col-md-6">
                        <input type="text" class="form-control" id="officeOrder" name="officeOrder" value=<?php echo $officeOrder ?> aria-label="Recipient's username" aria-describedby="button-addon2" >
                ...
                <div class="form-group p-2 col-md-6">
                    ...
                    <input type="text" class="form-control" id="officeOrder" name="officeOrder" value="Rs. <?php echo $totalFare ?>" >
                </div>
                <div class="row p-2">
                    <?php
                    if ($status == 0) {
                        ...
                        <div class="col-md-12">
                            <form action="editClaim.php" method="POST">
                                ...
                                <button class="btn btn-primary" type="submit" name="submit" id="submit"style="float: right;">Save</button>
                            </form>
                        </div>
                    <?php } ?>
                </div>
